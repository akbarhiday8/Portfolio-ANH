...
export const cmsModules: CmsModuleDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'heroImage', label: 'Latar suasana preview', type: 'image', wide: true, helper: 'Opsional. Gambar ini menjadi lapisan suasana yang sangat samar di belakang kartu preview, bukan mengganti Gambar utama. Kosongkan jika tidak diperlukan.' },
      { key: 'heroPosition', label: 'Fokus latar suasana', type: 'select', helper: 'Mengatur titik fokus lapisan suasana pada halaman detail. Pengaturan ini tidak memengaruhi posisi Gambar utama.', options: [
      ...
      { key: 'scope', label: 'Kontribusi utama', type: 'list', wide: true, helper: 'Satu bullet aktif otomatis. Tekan Enter untuk membuat bullet berikutnya; tekan Backspace pada awal bullet untuk kembali ke bullet sebelumnya.' },
      ...
      area('outcome', 'Hasil akhir', { helper: 'Satu bullet aktif otomatis. Tekan Enter untuk membuat bullet berikutnya; tekan Backspace pada awal bullet untuk kembali ke bullet sebelumnya.' }),
