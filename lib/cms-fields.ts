...
export const cmsModules: CmsModuleDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      text('evidence.label', 'Teks tombol bukti', { helper: 'Opsional. Jika kosong, website memilih label sesuai jenis hasil, misalnya “Lihat Website” atau “Buka Dokumen”.' }),
      ...
      area('outcome', 'Hasil akhir', { helper: 'Jelaskan hasil, dampak, atau kondisi akhir setelah proyek selesai.' }),
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'image', label: 'Bukti sertifikat', type: 'image', wide: true, helper: 'Portrait, landscape, dan rasio lain didukung otomatis pada CMS serta viewer publik.' },
